    ...
    for group, symbols in mt5_groups.items():
        for symbol in symbols:
            ...
            for tf in timeframes:
                ...
                for pattern_type, conf in pattern_defs.items():
                    params_list = conf.get('params', [])
                    years_back_list = conf.get('years_back', [])
                    ...
                    for params in params_list:
                        for years_back in years_back_list:
                            ...
                            stats, equity_series = get_pattern_statistics(
                                df, pattern_type, params, years_back
                            )
                            ...
                            session.commit()
                            print(f"[DONE] {symbol} {tf} {pattern_type} params={params} years_back={years_back}")
